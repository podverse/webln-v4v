...
html = nunjucks.render(`${__dirname}/../wordpress/webln_v4v.php`, { package: pkg });
fs.writeFileSync(`${__dirname}/../dist/webln_v4v.php`, html, "utf8");
...
shell.rm("-r", `${__dirname}/../dist/webln_v4v.php`);
